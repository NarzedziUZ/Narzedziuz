...
public final class ItemProductBinding implements ViewBinding {
  ...
  private ItemProductBinding(@NonNull CardView rootView, @NonNull ImageView imgProduct,
      @NonNull TextView tvManufacturer, @NonNull TextView tvPrice, @NonNull TextView tvProductName,
  ...
  public static ItemProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemProductBinding((CardView) rootView, imgProduct, tvManufacturer, tvPrice,
