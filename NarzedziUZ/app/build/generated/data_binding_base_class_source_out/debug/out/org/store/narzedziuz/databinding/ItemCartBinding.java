...
public final class ItemCartBinding implements ViewBinding {
  ...
  private ItemCartBinding(@NonNull CardView rootView, @NonNull ImageButton btnRemove,
      @NonNull ImageView imgProduct, @NonNull TextView tvManufacturer, @NonNull TextView tvPrice,
  ...
  public static ItemCartBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemCartBinding((CardView) rootView, btnRemove, imgProduct, tvManufacturer,
          tvPrice, tvProductName, tvQuantity);
    }
